...
if __name__ == "__main__":
    ...
    # =========================== args ===============================
    parser.add_argument( '--data_name', type=str, default='Adult Mouse Brain')#, help="'MERFISH' or 'V1_Breast_Cancer_Block_A_Section_1")
    # parser.add_argument('--data_name', type=str, default='Adult Mouse Brain', help='The name of dataset')
    # parser.add_argument('--data_path', type=str, default='dataset/Adult Mouse Brain (FFPE)/', help='The path to dataset')
    # parser.add_argument('--data_name', type=str, default='Adult Mouse Brain', help='The name of dataset')
